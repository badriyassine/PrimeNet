...
const offers = [
  {
    ...
    installation: "0 dh",
    equipment: "499 dh",
    bonus: "25% discount for old customers",
  },
  {
    name: "Satellite",
    price: "299 dh/month",
          ...
          >
            ...
            <div className="p-5 space-y-3 flex flex-col flex-grow">
              ...
              <ul className="text-sm text-gray-500 list-disc ml-5 space-y-1">
                {offer.installation && (
                  <li>Installation: {offer.installation}</li>
                )}

                {offer.equipment && <li>Equipment: {offer.equipment}</li>}

                {offer.bonus && (
                  <li className="text-green-600 font-medium">{offer.bonus}</li>
                )}
              </ul>

              {/* Button */}
              <Link to="/order">
                <button className="w-full cursor-pointer mt-auto bg-[#27b4e0] hover:bg-[#073651] text-white font-semibold py-3 rounded-full transition duration-300">
                  Subscribe
                </button>
              </Link>
            </div>
