    ...
    <section className="bg-gray-50 py-16 px-4">
      ...
      >
        {offers.map((offer, i) => (
          <div
            key={i}
            className="bg-white rounded-2xl shadow-md border border-gray-400 overflow-hidden 
          ...
          >
            ...
            <div className="p-5 space-y-3">
              {/* Speed */}
              <div className="flex items-center gap-3 border border-gray-400 rounded-lg p-3">
